            ...
            let html = `
                <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin-top: 10px;">
                    ...
                    <div style="margin-top: 15px; padding: 10px; background: #e8f4fd; border-radius: 5px;">
                        ...
                        🟢 FAST: ${result.recommendedSettings.fast}<br>
                        🟡 MEDIUM: ${result.recommendedSettings.medium}<br>
                        🟠 SLOW: ${result.recommendedSettings.slow}<br>
                        🔴 VERY_SLOW: ${result.recommendedSettings.verySlow}
                    </div>
                    
                    <small>Total Active Proxies: ${total} | Last Updated: ${new Date().toLocaleTimeString()}</small>
                </div>
            `;
