...
app.post('/api/start-session', async (req, res) => {
    try {
        ...
        res.json({ 
            success: true, 
            sessionId,
            message: 'Session started dengan basic proxy testing',
            details: {
                sessionId,
                proxySource: config.proxySource,
...
app.listen(PORT, () => {
    ...
    console.log(`🔒 System: BASIC PROXY PING TEST + NEW HEADLESS MODE`);
    console.log(`🎯 Test Method: Simple connectivity test to Google`);
    ...
    console.log(`   Proxy Test: Basic Ping Test`);
});