...
app.get('/api/system-info', (req, res) => {
    try {
        ...
        res.json({
            ...
            system: {
                version: '4.1.0',
                puppeteer: 'Extra + Stealth Version',
                features: 'Advanced Ads Detection + Stealth'
            },
            currentStatus: {
...
app.get('/api/test-puppeteer', async (req, res) => {
    try {
        ...
        res.json({ 
            success: true, 
            message: 'Puppeteer Extra + Stealth is working correctly',
            version: version,
            type: 'Extra + Stealth Version',
...
// Start Server
app.listen(PORT, () => {
    console.log(`\n🚀 Advanced Traffic Bot Server v4.1.0`);
