...
class TrafficGenerator {
  ...
  // 🎯 MAIN BROWSER LAUNCH - PUPPETEER FULL
  async launchBrowser(config, proxyUrl) {
    console.log('🚀 Launching browser with Puppeteer Full...');
    ...
    // ✅ Use environment Chromium if available (for Railway)
    ...
    try {
      ...
      console.log('✅ Browser launched successfully with Puppeteer Full');
      return browser;
    } catch (error) {
