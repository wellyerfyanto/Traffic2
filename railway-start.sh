...
echo "🚀 Starting Advanced Traffic Bot v4.2.1 - Railway Optimized"
echo "=========================================================="
...
echo "📦 Installing dependencies dengan legacy peer deps..."
...
# Test Puppeteer
echo "🧪 Testing Puppeteer dengan system Chromium..."
node -e "
...
async function test() {
  try {
    ...
    console.log('✅ Puppeteer Extra + Stealth test PASSED');
...
# Start application
echo "🎯 Starting application dengan optimized settings..."
node server.js